    ...
    return (
        <header className="h-screen flex flex-col items-center justify-center relative">
            ...
            <div className="absolute px-5">
                ...
                <p className="text-xl">
                    <span className="text-amber-400">SAPSAN TL</span> — надёжный партнёр в международной логистике. Полный комплекс: вагоны, экспедирование, документы, доставка под ключ.
                </p>
                <button
